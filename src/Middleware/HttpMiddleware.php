...
class HttpMiddleware
{
    ...
    public function __construct(Request $request = null, Response $response = null)
    {
        ...
        $this->request = $request->withAttribute('base_path', $this->getBasePath());
        $this->request = $request->withAttribute('base_uri', $this->getBaseUri());
        $this->request = $request->withAttribute('host_url', $this->getHostUrl());
